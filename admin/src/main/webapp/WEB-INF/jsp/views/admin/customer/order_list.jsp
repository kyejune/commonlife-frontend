...
<tiles:insertDefinition name="manage">
    ...
    <tiles:putAttribute name="contents">
        ...
        <div class="content-wrapper">
            ...
            <form:hidden path="boardType" value="ORDER"/>
            <!-- Main content -->
    ...
    <tiles:putAttribute name="js">
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#left_li_menu_04_02").addClass("active");
            })
...
//                $("#pageIndex").val(pageIndex);
            ...
            function refreshList(){
                $("#boardReqForm").attr("action", "/manage/customer/order_list.do");
                $("#boardReqForm").submit();
            }

            function boardDetail(boardIdx){
                $("#boardReqForm > #boardIdx").val(boardIdx);
                $("#boardReqForm").attr("action", "/manage/customer/order_view.do");
                $("#boardReqForm").submit();
            }

            function boardWrite(){
                $("#boardReqForm").attr("action", "/manage/customer/write.do");
                $("#boardReqForm").submit();
            }
