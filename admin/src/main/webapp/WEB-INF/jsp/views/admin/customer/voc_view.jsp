                            ...
                            <div class="box-body">
                                <table id="mngList" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <tr>
                                            <th>작성자</th>
                                            <th><c:out value="${boardDetail.writeNm}"/></th>

                                            <th>등록일</th>
                                            <th>
                                                <fmt:parseDate value="${boardDetail.regDttm}" pattern="yyyy-MM-dd" var="sysDt"/>
                                                <fmt:formatDate value="${sysDt}" pattern="yyyy.MM.dd"/>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>연락처</th>
                                            <th><c:out value="${boardDetail.writeHp}"/></th>

                                            <th>이메일</th>
                                            <th>
                                                <c:out value="${boardDetail.writeEmail}"/>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <tiles:putAttribute name="js">
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#left_li_menu_04_01").addClass("active");
            })
...
//                $("#pageIndex").val(pageIndex);
            ...
            function refreshList(){
                $("#boardListForm").attr("action", "/manage/customer/voc_list.do");
                $("#boardListForm").submit();
            }

            function boardDetail(boardIdx){
                $("#boardReqForm > #boardIdx").val(boardIdx);
                $("#boardReqForm").attr("action", "/manage/customer/voc_view.do");
                $("#boardReqForm").submit();
            }
