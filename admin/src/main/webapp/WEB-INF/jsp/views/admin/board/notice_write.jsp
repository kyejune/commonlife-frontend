        ...
        <div class="content-wrapper">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <label>
                        <c:choose>
                            <c:when test="${(boardType ne 'NOTICE') && (boardType ne 'PRESS')}">
                                <form:radiobutton path="boardType" value="NOTICE" checked="checked"/>공지사항
                            </c:when>
                            <c:otherwise>
                                <form:radiobutton path="boardType" value="NOTICE"/>공지사항
                            </c:otherwise>
                        </c:choose>
                    </label>&nbsp;&nbsp;&nbsp;
                    <label>
                ...
                <div class="form-group">
                    ...
                    -->
                    <textarea name="content" id="content" rows="10" cols="100" style="width:100%; height:412px;">
                            ${boardDetail.content}
                    </textarea>
    ...
    <tiles:putAttribute name="js">
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('input:radio[name=boardType]:input[value=${boardDetail.boardType}]').attr("checked", "checked");
                </c:if>
