...
<tiles:putAttribute name="contents">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>INFO 목록 관리 - ${complexInfo.cmplxNm}</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="/">Home</a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="ibox">
                    <div class="ibox-content" style="">
                        <h3>미배치 항목</h3>
                        <p class="small"><i class="fa fa-hand-o-up"></i> INFO 카테고리를 우측의 '적용된 항목'으로 옮겨 App에 배치할 수 있습니다.</p>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.each(categoryList, function(i, obj) {
                console.log(">>>>> " + obj.infoNm);

                //use obj.id and obj.name here, for example:
                categoryCard = '<li class="info-element" id="' + obj.infoKey + '">' +
                                    "항목 이름 : " + "<label class='font-bold'>" + obj.infoNm + "</label>" +
                                    '<div class="agile-detail">' +
                                    '<i class="fa fa-clock-o"></i> ' + obj.imgSrc +
                                    '</div>' +
                                '</li>';
        ...
        function procIns() {
            ...
            if( confirm("변경 사항을 적용하시겠습니까?") ) {
                $.ajax({
                    url : '/admin/info/procIns.do?cmplxId=${cmplxId}',
                    type : 'post',
                    dataType: 'json',
                    headers: h,
