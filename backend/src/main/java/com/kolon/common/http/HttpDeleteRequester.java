...
public class HttpDeleteRequester {
    final static private Logger logger = LoggerFactory.getLogger( HttpDeleteRequester.class );
    ...
    public HttpDeleteRequester(CloseableHttpClient httpClient, String host, String path)
    ...
    public HttpDeleteRequester setParameter(String param , String value ) {
        this.uriBuilder.setParameter(param, value);
        return this;
    }

    public HttpDeleteRequester setParameter(Map<String,String> paramMap) {
    ...
    public Map execute() throws URISyntaxException, IOException, HttpRequestFailedException {
        ...
        HttpDeleteWithBody httpDelete = new HttpDeleteWithBody(this.uriBuilder.build());
        httpDelete.addHeader( CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE );

        if( this.jsonBody != null ) {
            logger.debug(">>jsonBody: " + this.jsonBody);
            httpDelete.setEntity(new StringEntity(this.jsonBody, ContentType.APPLICATION_JSON));
        }
