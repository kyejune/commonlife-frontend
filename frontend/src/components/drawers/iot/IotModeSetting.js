            ...
            if( item.chk === 'N' ){
                ...
                return <LiOfCtrl key={index} icon={item.imgSrc}
                                 ...
                                 onClick={ this.state.isEditingDevice?undefined:
                                     ()=> Store.pushDrawer('edit-scan-device', { ...item, isScenario: ACTION_SCENARIO, callback: val => this.updateDeviceInfo( val, index ) } )}/>
        });
                ...
                <div className="pb-5em cl-bg--darkgray">
                    <div className="pt-05em bb--gray">
                        ...
                        { ACTION_SCENARIO && this.state.isEditingSensor &&
                            <button className="cl-iot-add__button--light pb-3em"
                                    onClick={ ()=>Store.pushDrawer( 'iot-sensor-list', { isCreate: isCreateMode, callback: this.gettedAddingSensors } ) }>
                    ...
                    <div>
                        ...
                        { ACTION_SCENARIO && this.state.isEditingDevice &&
                            <button className="cl-iot-add__button--light pb-3em"
                                    onClick={ ()=>Store.pushDrawer( 'iot-device-category-detail', { isCreate: isCreateMode, callback: this.gettedAddingDevices } ) }>
                                <img src={addSrc} alt="센서추가" width="40" height="40"/>
                            </button>
                        }
                    </div>
